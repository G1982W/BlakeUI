      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <div className="flex aspect-square size-8 items-center justify-center rounded-sm bg-background">
                <img
                  src={selected.logo}
                  alt={selected.name}
                  className="size-6"
          ...
          >
            ...
            {workspaces.map((workspace) => (
              <DropdownMenuItem
                ...
                className="gap-2 p-2"
              >
                <div className="flex size-6 items-center justify-center rounded-sm bg-background">
                  <img
                    src={workspace.logo}
                    alt={workspace.name}
                    className="size-4"
...
const Sidebar9 = ({ className, preview }: Sidebar9Props) => {
  const content = (
