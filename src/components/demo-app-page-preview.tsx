...
export interface DemoAppPagePreviewProps {
  bundleId: string;
...
export function DemoAppPagePreview({
  bundleId,
  children,
  className,
  previewClassName,
  premium = false,
}: DemoAppPagePreviewProps) {
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          {tab === "preview" && (
            <>
              <div className="hidden items-center rounded-md border border-border bg-code-background p-0.5 min-[769px]:flex">
                <button
                  type="button"
                  onClick={() => setPreviewWidth("mobile")}
                  aria-label="Mobile preview width"
                  className={cn(
                    "flex size-8 items-center justify-center rounded-sm text-muted-foreground transition-colors hover:bg-background hover:text-foreground",
                ...
                <button
                  ...
                  className={cn(
                    "flex size-8 items-center justify-center rounded-sm border-l border-border text-muted-foreground transition-colors hover:bg-background hover:text-foreground",
      ...
      {expanded && (
        ...
        >
          ...
          <div className="h-[calc(100vh-3.5rem)] max-h-[calc(100vh-3.5rem)] overflow-auto p-6">
            {children}
          </div>
        </div>
      )}
      ...
      >
        {tab === "preview" ? (
          <div className="flex w-full min-w-0 justify-center overflow-visible p-0 ring-offset-background transition-colors lg:p-2.5">
            <div
              className={cn(
                "@container w-full min-w-0 [&>*]:min-w-0 [&>*]:w-full",
