...
const ChartGroup8 = ({ className }: ChartGroup8Props) => {
  ...
  return (
    <section className={cn("@container w-full", className)}>
      <div className="mx-auto w-full grid gap-4 @3xl:grid-cols-2 @5xl:grid-cols-4">
        ...
        <Card className="@5xl:col-span-4">
          ...
          <CardContent>
            <div className="grid gap-6 @sm:grid-cols-2 @5xl:grid-cols-4">
...
export { ChartGroup8 as ChartGroup8Demo };
