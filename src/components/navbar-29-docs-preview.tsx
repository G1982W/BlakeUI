...
/**
 * Docs preview only: @container breakpoints for desktop/mobile mega menu layout.
 * Production component: `navbar-29`.
 */
...
interface Navbar29DocsPreviewProps {
  className?: string;
}

const Navbar29DocsPreview = ({ className }: Navbar29DocsPreviewProps) => {
