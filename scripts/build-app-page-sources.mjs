...
const BUNDLES = {
  ...
  "multi-step-form": [
    ...
    "src/components/multi-step-form-page-demo.tsx",
    ...
    "src/components/app-pages/multi-step-form-page-demo/page.tsx",
    "src/components/app-pages/multi-step-form-page-demo/components/sidebar.tsx",
    "src/components/app-pages/multi-step-form-page-demo/components/step-data-source.tsx",
    "src/components/app-pages/multi-step-form-page-demo/components/step-first-flow.tsx",
    "src/components/app-pages/multi-step-form-page-demo/components/step-invite-team.tsx",
    "src/components/app-pages/multi-step-form-page-demo/components/step-role-use-case.tsx",
    "src/components/app-pages/multi-step-form-page-demo/components/step-template.tsx",
  ],
  "todo-list-app": [
