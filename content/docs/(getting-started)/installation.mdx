...
Kickstart with a [Next.js starter](https://nextjs.org/docs/app/getting-started/installation). Everything is set up so you can begin building quickly.

## Initialize a NextJS Project

If you do not already have a Next.js project, follow the official [Next.js setup guide](https://nextjs.org/docs/app/getting-started/installation) to create one quickly.

## Make sure you have Tailwind CSS v4 installed

Follow the [Tailwind CSS setup for Next.js](https://tailwindcss.com/docs/installation/framework-guides/nextjs) and ensure you have a global CSS file (for example `app/global.css`).
...
Set up the utility helpers used across the docs/components. If you are new to utility-first styling, review [Tailwind utility classes](https://tailwindcss.com/docs/utility-first):
