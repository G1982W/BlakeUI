...
The line chart is built from the base **Chart** component and Recharts. See the [Chart](/docs/chart) doc for `ChartContainer`, `ChartConfig`, `ChartTooltip`, and `ChartLegend`. Recharts API: [LineChart](https://recharts.org/en-US/api/LineChart), [Line](https://recharts.org/en-US/api/Line).
