...
It uses the [Button](/docs/button) and [Collapsible](/docs/collapsible) components. Ideal for file managers, dev tools, or any app that needs a VS Code–like layout.
