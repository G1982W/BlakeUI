...
Uses [Button](/docs/button), [Input](/docs/input), and [Avatar](/docs/avatar). Suited to dashboards or sidebars where users need quick profile edits without a full form.
