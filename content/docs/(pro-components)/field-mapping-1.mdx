...
Uses [Button](/docs/button), [Badge](/docs/badge), [Combobox](/docs/combobox), [Dialog](/docs/dialog), and [Table](/docs/table). Suited to ETL, CRM imports, or spreadsheet integrations where users map file columns to app fields.
