...
The Data Table is built with the base [Table](/docs/table) component and [TanStack Table](https://tanstack.com/table/latest). It gives you a flexible, headless way to build tables with:
